...
You can download the latest release [from GitHub](https://github.com/probe-rs/probe-rs/releases/tag/v0.31.0) or build it from source using

```shell
cargo install probe-rs-tools@0.31.0 --locked
```
