...
| The Pico 2 does not connect to your mobile WiFi | Check your WiFi settings and make sure that you're using 2.4 GHz and not 5 GHz (some devices default to 5 GHz, but will usually have a setting called something like "maximize/improve compatibility" if you can't select the frequency explicitly). On iPhone, make sure to "allow unknown devices". |
